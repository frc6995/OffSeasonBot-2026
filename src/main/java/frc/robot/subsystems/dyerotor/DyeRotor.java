...
public class DyeRotor extends SubsystemBase {
  public static final class DyeRotorConstants {
    ...
    public static final int kSpinMotorCANID = 21; // Tune
    public static final int kLeadIndexMotorCANID = 22; // Tune
    public static final int kFollowIndexMotorCANID = 23; // Tune
