...
// in torque current amps
    public static final double kP = 0.00001;   // amps per (rot/s) velocity error
    public static final double kS = 0.0;    // breakaway amps
    ...
    public static final double kSafeShotRPM = 700;
    // Sim Constants
